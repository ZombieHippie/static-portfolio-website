...
/***/ function(module, exports, __webpack_require__) {
	...
	var $, MobileDetect, isMobile, loadVideo, md, num, template, videos;
	...
	MobileDetect = __webpack_require__(13);
	...
	videos = [["couch-sit", "Me sitting on a comfortable couch, opening my laptop, and continuing to program.", 7.7]];
	...
	loadVideo = function(num) {
	  var video;
	  video = videos[num];
	  return $(".background-video").html(template({
	    filename: video[0],
	    alt: video[1],
	    loopstart: video[2],
	    isMobile: isMobile
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jade_mixins = {};
	var jade_interp;
	;var locals_for_with = (locals || {});(function (alt, filename, isMobile, loopstart) {
	if ( isMobile)
	{
	buf.push("<img" + (jade.attr("src", "/video/" + (filename) + ".jpg", true, false)) + (jade.attr("alt", "" + (alt) + "", true, false)) + "/>");
	}
	else
	{
	buf.push("<video autoplay=\"autoplay\"" + (jade.attr("onended", 'this.currentTime=' + (loopstart) + ';', true, false)) + (jade.attr("alt", "" + (alt) + "", true, false)) + "><source" + (jade.attr("src", "/video/" + (filename) + ".ogv", true, false)) + " type=\"video/ogg; codecs=&quot;theora, vorbis&quot;\"/><source" + (jade.attr("src", "/video/" + (filename) + ".webm", true, false)) + " type=\"video/webm\"/><source" + (jade.attr("src", "/video/" + (filename) + ".mp4", true, false)) + " type=\"video/mp4\"/>Your browser does not support the video tag.</video>");
	}}.call(this,"alt" in locals_for_with?locals_for_with.alt:typeof alt!=="undefined"?alt:undefined,"filename" in locals_for_with?locals_for_with.filename:typeof filename!=="undefined"?filename:undefined,"isMobile" in locals_for_with?locals_for_with.isMobile:typeof isMobile!=="undefined"?isMobile:undefined,"loopstart" in locals_for_with?locals_for_with.loopstart:typeof loopstart!=="undefined"?loopstart:undefined));;return buf.join("");
	}
