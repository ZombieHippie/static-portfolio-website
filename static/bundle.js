...
/***/ function(module, exports, __webpack_require__) {
	...
	var $, loadVideo, num, template, videos;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jade_mixins = {};
	var jade_interp;
	;var locals_for_with = (locals || {});(function (filename, loopstart) {
	buf.push("<video autoplay=\"autoplay\"" + (jade.attr("onended", 'this.currentTime=' + (loopstart) + ';', true, false)) + "><source" + (jade.attr("src", "/video/" + (filename) + ".ogv", true, false)) + " type=\"video/ogg; codecs=&quot;theora, vorbis&quot;\"/><source" + (jade.attr("src", "/video/" + (filename) + ".webm", true, false)) + " type=\"video/webm\"/><source" + (jade.attr("src", "/video/" + (filename) + ".mp4", true, false)) + " type=\"video/mp4\"/>Your browser does not support the video tag.</video>");}.call(this,"filename" in locals_for_with?locals_for_with.filename:typeof filename!=="undefined"?filename:undefined,"loopstart" in locals_for_with?locals_for_with.loopstart:typeof loopstart!=="undefined"?loopstart:undefined));;return buf.join("");
	}
